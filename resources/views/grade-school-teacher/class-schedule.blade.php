{{-- resources/views/grade-school-teacher/class-schedule.blade.php --}}
...
(function () {
    ...
    function loadSchedules() {
        fetch('/api/grade-school-teacher/classes', {
            headers: { 'X-CSRF-TOKEN': CSRF, 'Accept': 'application/json' }
        })
        .then(r => r.json())
        .then(data => {
            let raw = Array.isArray(data) ? data : (data.data || []);
            // API already filters admin_approved + active, but guard just in case
            ...
            return `<div class="sched-card">
                ...
                <div class="sched-body">
                    ...
                    <div class="sched-meta">
                        ...
                        <span><svg width="13" height="13" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>${esc(s.grade_section || ((s.grade_level || '') + (s.section_name ? ' – ' + s.section_name : '')) || '—')}</span>
                    </div>
                    ${approvedOn}
                </div>
