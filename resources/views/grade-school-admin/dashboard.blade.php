...
@section('content')
    ...
    @include('partials.admin-weekly-timetable', [
        ...
        'grades' => ['nursery', 'kinder1', 'kinder2', '1', '2', '3', '4', '5', '6'],
        ...
        'sections' => [
            'nursery' => \App\Support\KinderScheduleSupport::SECTIONS_BY_GRADE['Nursery'],
            'kinder1' => \App\Support\KinderScheduleSupport::SECTIONS_BY_GRADE['Kinder 1'],
            'kinder2' => \App\Support\KinderScheduleSupport::SECTIONS_BY_GRADE['Kinder 2'],
