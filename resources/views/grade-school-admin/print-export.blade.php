{{-- resources/views/grade-school-admin/print-export.blade.php --}}
...
<div class="pe-filter-card">
    <form method="GET" action="{{ route('grade-school-admin.print-export') }}" id="peFilterForm">
...
<div class="pe-action-bar">
    ...
    <a class="pe-btn pe-btn-secondary"
       href="{{ route('grade-school-admin.export.excel', array_filter(['grade_level' => $gradeLevel, 'day_of_week' => $dayOfWeek])) }}">
    ...
    <a class="pe-btn pe-btn-secondary"
       href="{{ route('grade-school-admin.export.csv', array_filter(['grade_level' => $gradeLevel, 'day_of_week' => $dayOfWeek])) }}">
