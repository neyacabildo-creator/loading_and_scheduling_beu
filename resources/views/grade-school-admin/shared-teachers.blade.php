{{-- resources/views/grade-school-admin/shared-teachers.blade.php --}}
...
<div class="sf-container">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem;flex-wrap:wrap;gap:1rem;">
        <div>
            <h1 style="font-size:1.5rem;font-weight:700;color:var(--text-primary);margin:0;">Shared Teachers</h1>
            <p style="color:var(--text-secondary);font-size:.875rem;margin:.25rem 0 0;">Manage teachers shared between Grade School and Junior High.</p>
        </div>
    ...
    <div class="sht-card">
        ...
        <p style="font-size:.82rem;color:var(--text-secondary);margin:0 0 1.2rem;">Add a teacher who also teaches in Junior High. They will be marked as <span class="sht-badge-shared">Shared</span> in schedule creation.</p>
        <form method="POST" action="{{ route('grade-school-admin.shared-teachers.store') }}">
            @csrf
            <div class="sht-grid">
                <div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="white-space:nowrap;">
                        <form method="POST" action="{{ route('grade-school-admin.shared-teachers.toggle', $st->id) }}" style="display:inline;">
                            @csrf @method('PATCH')
                        ...
                        <form method="POST" action="{{ route('grade-school-admin.shared-teachers.destroy', $st->id) }}" style="display:inline;" onsubmit="return confirm('Remove {{ addslashes($st->teacher_name) }} from shared teachers?')">
                            @csrf @method('DELETE')
