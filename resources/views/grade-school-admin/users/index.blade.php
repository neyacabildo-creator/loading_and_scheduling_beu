...
@section('content')
    ...
    <div class="table-card">
        <div class="table-header">
            ...
            <input type="text" name="gs_autofill_trap" value="" tabindex="-1" autocomplete="username" aria-hidden="true" style="position:absolute;left:-9999px;width:1px;height:1px;opacity:0;pointer-events:none;">
            <input type="text" id="searchInput" name="gs_user_account_q" placeholder="Search by name or email..." autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" readonly data-lpignore="true" data-1p-ignore style="padding: 0.5rem 1rem; border: 1px solid #e8dcc8; border-radius: 0.375rem; font-size: 0.875rem;" onfocus="this.removeAttribute('readonly')" oninput="handleUserSearchInput()">
        </div>
    ...
    <script>
        ...
        function renderTeachers(teachers) {
            ...
            tbody.innerHTML = teachers.map(t => {
                ...
                return `<tr id="gs-teacher-row-${t.id}">
                    ...
                    <td>${pwdCell}</td>
                    <td>${roleName}</td>
                    <td><span class="ua-school-badge">Grade School</span></td>
        ...
        function submitAddUser() {
            ...
            if (roleName === 'shared_teacher') {
                const s1 = document.getElementById('gs_subject1').value.trim();
                const s2 = document.getElementById('gs_subject2').value.trim();
                if (!s1) {
