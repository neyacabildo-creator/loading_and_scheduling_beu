...
@section('content')
    ...
    <div class="header">
        ...
        <div class="header-right">
            <a href="{{ route('grade-school-admin.users') }}" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; background: transparent; color: var(--text-primary); border: 1px solid var(--border-color); border-radius: 0.5rem; text-decoration: none; font-weight: 600; font-size: 0.875rem;">
                ← Back to Users
            </a>
        </div>
    </div>
    ...
    <div class="table-card" style="max-width: 600px;">
        ...
        <form style="padding: 2rem;" action="#" method="POST">
            ...
            <div style="display: flex; gap: 1rem;">
                ...
                <a href="{{ route('grade-school-admin.users') }}" style="flex: 1; padding: 0.75rem; background: var(--bg-primary); color: var(--text-primary); border: 1px solid var(--border-color); border-radius: 0.5rem; cursor: pointer; font-weight: 600; text-align: center; text-decoration: none;">Cancel</a>
            </div>
        </form>
    </div>
@endsection
