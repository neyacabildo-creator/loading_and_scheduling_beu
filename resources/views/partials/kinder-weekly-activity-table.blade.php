...
<table class="ks-table" style="width:100%;border-collapse:collapse;font-size:0.82rem;">
    ...
    <thead>
        <tr>
            ...
            <th style="background:var(--bg-tertiary);padding:.5rem;border:1px solid var(--border-color);">SUBJECT</th>
        </tr>
    </thead>
    <tbody>
        @foreach($weekdays as $day)
            <tr>
                ...
                <td style="border:1px solid var(--border-color);padding:.35rem;">
                    <select name="activity[{{ $day }}]" required title="Subject" style="width:100%;padding:.45rem;border:1px solid var(--border-color);border-radius:.35rem;background:var(--bg-secondary);">
