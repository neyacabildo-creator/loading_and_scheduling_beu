...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.shared-teacher-requests') }}" class="nav-item {{ request()->routeIs('admin.shared-teacher-requests*', 'admin.teacher-schedule-requests*') ? 'active' : '' }}" style="position:relative;">
