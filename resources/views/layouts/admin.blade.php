...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Text elements with hardcoded dark color */
        ...
        /* Table headers using hardcoded #f5f3ed */
        ...
        /* Inline-style overrides — catches style="background: white" etc. */
    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            ...
            <div>
                ...
                <div class="sidebar-subtitle">Junior High School Admin</div>
            </div>
        </div>
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.monitoring-alerts') }}" class="nav-item {{ request()->routeIs('admin.monitoring-alerts') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                <span>Monitoring &amp; Alerts</span>
            </a>

            <a href="{{ url('/admin/rooms-sections') }}" class="nav-item {{ request()->routeIs('admin.rooms-sections*') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                <span>Rooms &amp; Sections</span>
            </a>

            <a href="{{ route('admin.shared-teacher-requests') }}" class="nav-item {{ request()->routeIs('admin.shared-teacher-requests*', 'admin.teacher-schedule-requests*', 'admin.teacher-leave-requests*') ? 'active' : '' }}" style="position:relative;">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path></svg>
                <span>All Requests</span>
                @php
                    try {
                        $stPendingJh = \Illuminate\Support\Facades\DB::connection('mysql_jh')
                            ->table('shared_teacher_requests')->where('status', 'pending')->count();
                        if (\Illuminate\Support\Facades\Schema::connection('mysql_jh')->hasTable('teacher_requests')) {
                            $stPendingJh += \Illuminate\Support\Facades\DB::connection('mysql_jh')
                                ->table('teacher_requests')->where('status', 'pending')->count();
                        }
                        if (\Illuminate\Support\Facades\Schema::connection('mysql_jh')->hasTable(\App\Support\TeacherLeaveRequestSupport::TABLE)) {
                            $stPendingJh += \Illuminate\Support\Facades\DB::connection('mysql_jh')
                ...
                @endphp
                @if($stPendingJh > 0)
                    <span style="margin-left:auto;background:#ef4444;color:white;font-size:0.7rem;font-weight:700;border-radius:9999px;padding:1px 7px;line-height:1.5;">{{ $stPendingJh }}</span>
                @endif
            </a>
            ...
            <a href="{{ url('/admin/users') }}" class="nav-item {{ request()->routeIs('admin.users') ? 'active' : '' }}">
            ...
            <a href="{{ url('/admin/system-logs') }}" class="nav-item {{ request()->routeIs('admin.system-logs') ? 'active' : '' }}">
            ...
            @endphp
            <a href="{{ route('admin.permission-requests') }}" class="nav-item {{ request()->routeIs('admin.permission-requests') ? 'active' : '' }}" style="position:relative;">
            ...
            <a href="{{ url('/admin/settings') }}" class="nav-item {{ request()->routeIs('admin.settings') ? 'active' : '' }}">
