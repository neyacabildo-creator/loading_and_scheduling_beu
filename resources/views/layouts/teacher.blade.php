...
<body>
    ...
    <aside class="sidebar" id="mainSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('teacher.request-adjustments') }}" class="nav-item {{ request()->routeIs('teacher.request-adjustments') ? 'active' : '' }}">
    ...
    <script>
        ...
        function updateThemeButton() {
            ...
            if (themeBtn && !toolbarIcon) themeBtn.innerHTML = isDark ? sunSvgFilled : moonSvgFilled;
        }
