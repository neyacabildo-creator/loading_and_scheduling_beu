...
<!-- JH Schedules -->
<div class="st-schedule-panel jh">
    <div class="st-panel-head">
        <div class="st-panel-title">
            <span class="badge-jh">JH</span>
            Junior High School — Approved Schedules
        </div>
        <span class="st-panel-count">{{ count($jhSchedules) }} {{ count($jhSchedules) === 1 ? 'class' : 'classes' }}</span>
    </div>
    @if($jhSchedules->isEmpty())
        <div class="st-empty-state">
            ...
            No approved Junior High schedules found.
        </div>
    @else
    <div class="st-schedule-table-wrap">
        <table class="st-schedule-table">
            <thead>
                <tr>
                    <th>Subject</th>
                    <th>Grade &amp; Section</th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="st-subject-cell">{{ $s->subject }}</td>
                    <td class="st-grade-cell">{{ $stGradeSection($s) }}</td>
                    <td><span class="st-day-chip">{{ $s->day_of_week ?? '—' }}</span></td>
                    <td class="st-time-cell">{{ $stFormatTime($s) }}</td>
                    <td>
                        <span class="st-room-badge" title="Grade level and section">
...
<!-- GS Schedules -->
<div class="st-schedule-panel gs">
    <div class="st-panel-head">
        <div class="st-panel-title">
            <span class="badge-gs">GS</span>
            Grade School — Approved Schedules
        </div>
        <span class="st-panel-count">{{ count($gsSchedules) }} {{ count($gsSchedules) === 1 ? 'class' : 'classes' }}</span>
    </div>
    @if($gsSchedules->isEmpty())
        <div class="st-empty-state">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
            No approved Grade School schedules found.
        </div>
    @else
    <div class="st-schedule-table-wrap">
        <table class="st-schedule-table">
