...
@section('content')
    ...
    <div class="form-container">
        <h1 class="page-title" style="margin-bottom: 2rem;">Add New Room</h1>
        ...
        <div class="form-card">
            <form method="POST" action="{{ route('admin.rooms.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="room_number" class="form-input @error('room_number') form-error @enderror" value="{{ old('room_number') }}" placeholder="e.g., 101, A-203" required>
                    @error('room_number')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="building" class="form-input @error('building') form-error @enderror" value="{{ old('building') }}" placeholder="e.g., Main Building, Extension" required>
                    @error('building')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="capacity" class="form-input @error('capacity') form-error @enderror" value="{{ old('capacity', 30) }}" min="1" max="200" required>
                    @error('capacity')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-group">
                        <div class="checkbox-item">
                            <input type="checkbox" id="has_laboratory" name="has_laboratory" value="1" {{ old('has_laboratory') ? 'checked' : '' }}>
                            <label for="has_laboratory">Has Laboratory 🧪</label>
                        </div>
                        <div class="checkbox-item">
                            <input type="checkbox" id="has_projector" name="has_projector" value="1" {{ old('has_projector') ? 'checked' : '' }}>
                            <label for="has_projector">Has Projector 📽️</label>
                        </div>
                        <div class="checkbox-item">
                            <input type="checkbox" id="has_ac" name="has_ac" value="1" {{ old('has_ac') ? 'checked' : '' }}>
                            <label for="has_ac">Has AC ❄️</label>
                        </div>
                    </div>
                </div>
