                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;align-items:center;gap:0.4rem;flex-wrap:nowrap;">
                                ...
                                ${load.faculty_id && load.has_user_account ? `<a href="${masterScheduleBaseUrl}/${load.faculty_id}" style="padding:0.4rem 0.75rem;border:1px solid var(--green-primary);border-radius:0.375rem;font-size:0.75rem;font-weight:500;background:var(--green-primary);color:white;text-decoration:none;display:inline-block;white-space:nowrap;">Faculty Loads</a>` : ''}
                            </div>
                        </td>
                    </tr>
                `;
