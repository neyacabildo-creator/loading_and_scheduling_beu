...
@section('content')
    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <button class="header-btn" style="position: relative;" onclick="window.location='{{ route('admin.shared-teacher-requests') }}'">
                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                @if(($stReqPending ?? 0) > 0)
                    <span style="position:absolute;top:2px;right:2px;background:#ef4444;color:#fff;font-size:.6rem;font-weight:700;border-radius:9999px;min-width:16px;height:16px;display:flex;align-items:center;justify-content:center;padding:0 3px;line-height:1;">{{ $stReqPending }}</span>
                @else
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card" style="cursor:pointer;" onclick="window.location='{{ route('admin.shared-teacher-requests') }}'">
    ...
    <div id="jhDssPanel" style="margin-bottom:1.5rem;">
    ...
    @include('partials.admin-weekly-timetable', [
        ...
        'grades' => ['7', '8', '9', '10'],
        'slots' => [
            ['label' => "7:45\n8:45", 'start' => '07:45', 'end' => '08:45', 'isBreak' => false],
            ['label' => 'RECESS', 'start' => '08:45', 'end' => '09:15', 'isBreak' => true],
            ['label' => "9:15\n10:15", 'start' => '09:15', 'end' => '10:15', 'isBreak' => false],
            ['label' => "10:15\n11:15", 'start' => '10:15', 'end' => '11:15', 'isBreak' => false],
            ['label' => "11:15\n12:15", 'start' => '11:15', 'end' => '12:15', 'isBreak' => false],
            ['label' => 'LUNCH', 'start' => '12:15', 'end' => '13:15', 'isBreak' => true],
            ['label' => "1:15\n2:15", 'start' => '13:15', 'end' => '14:15', 'isBreak' => false],
            ['label' => "2:15\n3:15", 'start' => '14:15', 'end' => '15:15', 'isBreak' => false],
            ['label' => "3:15\n4:15", 'start' => '15:15', 'end' => '16:15', 'isBreak' => false],
            ['label' => "4:15\n5:15", 'start' => '16:15', 'end' => '17:15', 'isBreak' => false],
        ],
        'sections' => [
    ...
    <script>
        ...
        // ── Initialise ─────────────────────────────────────────────────────────
        // ─── DSS Auto-Alerts ───────────────────────────────────────────────────────
        function renderDssAlerts(res) {
            const el = document.getElementById('jhDssPanel');
            if (!el) return;
            ...
            if (total > 5) html += `<div style="text-align:right;margin-top:.3rem;"><a href="{{ route('admin.dss-recommendations') }}" style="font-size:.77rem;color:var(--green-primary);text-decoration:none;font-weight:600;">View all ${total} recommendations &#8594;</a></div>`;
            el.innerHTML = html;
        }

        function loadDssAlerts() {
            const token = document.querySelector('meta[name="csrf-token"]')?.content || '';
            fetch('{{ url("api/admin/dss/analyze") }}', {
                method: 'POST',
                headers: {'Accept':'application/json','Content-Type':'application/json','X-CSRF-TOKEN':token}
            })
            .then(r => r.ok ? r.json() : Promise.reject(r.status))
            .then(res => renderDssAlerts(res))
            .catch(() => { const el=document.getElementById('jhDssPanel'); if(el) el.innerHTML=''; });
        }
