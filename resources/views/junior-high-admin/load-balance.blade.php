{{-- resources/views/junior-high-admin/load-balance.blade.php --}}
@extends('layouts.admin')

@section('title', 'Faculty Load Balance — Junior High')
...
<style>
    ...
    /* ── Threshold line ───────────────────────────────────────────── */
    .threshold-line { position:absolute; top:0; height:100%; width:2px; background:rgba(239,68,68,.6); z-index:1; }
...
<!-- Summary stat cards -->
        <div class="stat-row4" id="statRow">
...
<script>
(function () {
    const API_URL = '/api/admin/load-balance/data';
