...
@section('content')
    @include('partials.teacher-dashboard-welcome-banner', [
        'divisionLabel' => 'Junior High School Division',
        'greetingId' => 'jhGreeting',
        'dateId' => 'jhLiveDate',
        'notificationsApi' => '/api/teacher/notifications',
        'markReadApi' => '/api/teacher/notifications/read',
    ])
