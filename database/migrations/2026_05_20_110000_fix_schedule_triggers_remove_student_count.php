...
/**
 * Remove student_count from pending/rejected schedule triggers and tables
 * after class_schedules.student_count was dropped.
 */
    ...
    public function up(): void
    {
        foreach ($this->schoolConns as $conn) {
            ...
            if (Schema::connection($conn)->hasTable('pending_schedules')
                && Schema::connection($conn)->hasColumn('pending_schedules', 'student_count')) {
            ...
            if (Schema::connection($conn)->hasTable('rejected_schedules')
                && Schema::connection($conn)->hasColumn('rejected_schedules', 'student_count')) {
            ...
            if (Schema::connection($conn)->hasTable('rejected_schedules')) {
                ...
                DB::connection($conn)->unprepared("
                    ...
                    END
                ");
                // Do not delete rejected_schedules audit row when class_schedules is removed after rejection.
            }
        }
    }
